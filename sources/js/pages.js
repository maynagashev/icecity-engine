...
function page_switch(obj) {
    ...
    if (childs=='') {
      ...
      $.post("./post.php", {act : "page_childs",  id : pageid}, function (data) {
...
// @deprecated 
function bindBehaviors(id) {  
  alert("binding #page-"+id+"-childs");
  alert($("#page-"+id+"-childs").children(".page-switcher"));
  
  $("#page-"+id+"-childs").children(".page-switcher").click(function() {
    return page_switch(this);
  });
}
