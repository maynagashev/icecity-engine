 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,imageLoading:'/i/lightbox/lightbox-ico-loading.gif',imageBtnPrev:'/i/lightbox/lightbox-btn-prev.gif',imageBtnNext:'/i/lightbox/lightbox-btn-next.gif',imageBtnClose:'/i/lightbox/lightbox-btn-close.gif',imageBlank:'/i/lightbox/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
