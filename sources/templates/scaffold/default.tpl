...
<tr><tD>  
  <table width="100%"><tr> 
    ...
    <td align="right" style=''>Кол-во элементов в списке: <b>{if $ar.pl.size}{$ar.pl.size}{else}0{/if}</b>{if $ar.all_count && $ar.pl.size<>$ar.all_count} из <b>{$ar.all_count}</b>{/if}.</td>
  </table>
  </td></tr>
