 ...
 * Inno.php
 * ----------
 * Author: Thomas Klingler (hotline@theratech.de) based on delphi.php from Jбrja Norbert (jnorbi@vipmail.hu)
 * Copyright: (c) 2004 Jбrja Norbert, Nigel McNie (http://qbnz.com/highlighter)
